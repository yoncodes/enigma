...
use sonettobuf::{
    ...
    ArcadeAttrChangePush, ArcadeAttrContainer, ArcadeAttrValue, ArcadeBook, ArcadeBookInfo,
    ArcadeExtendInfo, ArcadeGainRewardReply, ArcadeGainRewardRequest, ArcadeGetInSideInfoReply,
    ArcadeGetInSideInfoRequest, ArcadeGetOutSideInfoReply, ArcadeGetOutSideInfoRequest,
    ArcadeInSideInfo, ArcadeInSideProp, ArcadePlayer, ArcadeSaveGameReply,
    ArcadeSaveGameRequest, ArcadeSettleGameReply, ArcadeSettleGameRequest,
    ArcadeTalentUpgradeReply, ArcadeTalentUpgradeRequest, CurrencyChangePush, FinishTaskReply,
    FinishTaskRequest, GainInviteRewardReply, GainInviteRewardRequest, GetAct220InfoReply,
    GetAct220InfoRequest, GetAct233BpBonusReply, GetAct233BpBonusRequest, GetAct233BpInfoReply,
